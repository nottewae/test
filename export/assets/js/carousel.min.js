 ...
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 * ======================================================================== */
+function(t){"use strict";function e(e){return this.each(function(){var i=t(this),o=i.data("bs.popover"),r="object"==typeof e&&e;(o||!/destroy|hide/.test(e))&&(o||i.data("bs.popover",o=new n(this,r)),"string"==typeof e&&o[e]())})}var n=function(t,e){this.init("popover",t,e)};if(!t.fn.tooltip)throw new Error("Popover requires tooltip.js");n.VERSION="3.3.4",n.DEFAULTS=t.extend({},t.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'}),n.prototype=t.extend({},t.fn.tooltip.Constructor.prototype),n.prototype.constructor=n,n.prototype.getDefaults=function(){return n.DEFAULTS},n.prototype.setContent=function(){var t=this.tip(),e=this.getTitle(),n=this.getContent();t.find(".popover-title")[this.options.html?"html":"text"](e),t.find(".popover-content").children().detach().end()[this.options.html?"string"==typeof n?"html":"append":"text"](n),t.removeClass("fade top bottom left right in"),t.find(".popover-title").html()||t.find(".popover-title").hide()},n.prototype.hasContent=function(){return this.getTitle()||this.getContent()},n.prototype.getContent=function(){var t=this.$element,e=this.options;return t.attr("data-content")||("function"==typeof e.content?e.content.call(t[0]):e.content)},n.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")};var i=t.fn.popover;t.fn.popover=e,t.fn.popover.Constructor=n,t.fn.popover.noConflict=function(){return t.fn.popover=i,this}}(jQuery),function(){$(document).ready(function(){var t;return t="undefined"!=typeof exports&&null!==exports?exports:this,$(".companion-slide").length>0?($(".companion-slide").height($(window).height()),$(".companion-slide").each(function(t,e){var n;return $(e).height($(window).height()),"none"!==$(e).css("background-image")&&(n=window.rezise_background($(e),$(e).css("background-image").split("(")[1].split(")")[0])),window.place_elements($(e))}),$(window).resize(function(){return $(".companion-slide").each(function(t,e){var n;return $(e).height($(window).height()),"none"!==$(e).css("background-image")&&(n=window.rezise_background($(e),$(e).css("background-image").split("(")[1].split(")")[0])),window.place_elements($(e))})})):void 0}),this.current_slide=0,this.images={count:0},this.place_elements=function(t){t.find(".middle").css({top:(t.height()-t.find(".middle").height())/2+"px"})},this.rezise_background=function(t,e){var n,i,o;return o="undefined"!=typeof exports&&null!==exports?exports:this,o.images[o.images.count]||(o.images[o.images.count]={},o.images.count++,i=new Image,i.onload=function(){return o.images[o.images.count]={w:i.width,h:i.height}},i.src=e),o.images[o.images.count]?($(".video_overlay").each(function(t,e){var n,i;return n=$($(e).data("video")).height(),i=$($(e).data("video")).width(),$(e).css({height:n,top:"-"+n+"px"}),$($(e).data("video")).unbind("loadedmetadata"),$($(e).data("video")).bind("loadedmetadata",function(){return setTimeout(function(){return $(window).resize()},200)})}),$(".video-overlay").css({}),n=o.images[o.images.count],n.tmp_width=$(window).width(),n.wK=n.w/n.h,n.tmp_height=n.tmp_width/n.wK,n.tmp_height<$(window).height()&&(n.tmp_width=$(window).height()*n.wK,n.tmp_height=n.tmp_width/n.wK),n.left_offset=($(window).width()-n.tmp_width)/2,n.top_offset=($(window).height()-n.tmp_height)/2,t.css({"background-size":n.tmp_width+"px","background-position":n.left_offset+"px "+n.top_offset+"px"}),n):void setTimeout(function(){return this.rezise_background(t,t.css("background-image").split("(")[1].split(")")[0])})}}.call(this);